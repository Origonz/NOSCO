...
public class Home extends javax.swing.JFrame {
    ...
    public Home(String Bdd) {
        initComponents();
        co = new Connexion(Bdd);
        co.connect();
    }
    ...
    public String getpseudo(String role) {

        if (role == "admin") {
            ResultSet resultSet = co.query("Select * From Connexion where role = 'administrateur'");
            try {
        ...
        if (role == "correct") {
            ResultSet resultSet = co.query("Select * From Connexion where role = 'correcteur'");
            try {
                while (resultSet.next()) {
                    return resultSet.getString("pseudo");
                }
    ...
    public String getmdp(String role) {
    ...
    void setPseudoAdmin(String n){
        co.modif("Update Connexion set pseudo = '" + n + "' where role = 'administrateur'");
    }
    
    void setPseudocorrect(String n){
        co.modif("Update Connexion set pseudo = '" + n + "' where role = 'correcteur'");
    }
    
    void setMdpAdmin(String n){
        co.modif("Update Connexion set mdp = '" + n + "' where role = 'administrateur'");
    }
    
    void setMdpCorrect(String n){
        co.modif("Update Connexion set mdp = '" + n + "' where role = 'correcteur'");
    }
    ...
    public void connect() {
        ...
        f = jPasswordField1.getText();
        
        System.out.println(a + " " + b + " " + c + " " + d + " " + e + " " + f);
        
        if(a.equals(e) && c.equals(f)){
            System.out.println("Je suis administrateur");
        }
        if(b.equals(e) && d.equals(f)){
            System.out.println("Je suis correcteur");
        }
    }
